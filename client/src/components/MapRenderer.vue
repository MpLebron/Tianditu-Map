...
<head>
    ...
    <script src="https://api.tianditu.gov.cn/api?v=4.0&tk=1d0dcde810c40ba139e57ec790e56a05" type="text/javascript"><\/script>
    <style type="text/css">
        body, html {
            width: 100%;
            height: 100%;
    ...
    <script type="text/javascript"
            src="https://lbs.tianditu.gov.cn/api/js4.0/opensource/openlibrary/HeatmapOverlay.js"><\/script>
    <script>
        var data = [
            {name: '海门', value: 9},
            {name: '鄂尔多斯', value: 12},
